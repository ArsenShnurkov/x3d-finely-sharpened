...
{
    /// <summary>
    ///     Represents a reader that provides fast, non-cached, forward-only access to XML binary encoded data that conforms to
    ///     the ITU-T: Fast infoset X.891 (05/2005) recommendation.
    /// </summary>
    /// <remarks>
    ///     The FIReader class derives from the System.Xml.XmlReader .Net Framework class and supports the abstract
    ...
    public sealed class FIReader : XmlReader
    {
        ...
        /// </summary>
        /// <param name="url">The URL for the file containing the XML data.</param>
        /// <param name="vocabularyManager">
        ///     A <see cref="FIVocabularyManager" /> containing a mapping of URIs to
        ///     <see cref="FIExternalVocabulary" /> objects. If the Fast Infoset to be read references an External Vocabulary, the
        ///     URI used must exist with the provided vocabulary manager.
        /// </param>
        /// <exception cref="ArgumentNullException">url is a null reference (Nothing in Visual Basic)</exception>
        /// <exception cref="ArgumentException">url is an empty string.</exception>
        /// <exception cref="UriFormatException">url is not a valid URI.</exception>
        ...
        public FIReader(string url, FIVocabularyManager vocabularyManager, XmlNameTable nameTable)
        {
            ...
            var input = (Stream)new XmlUrlResolver().GetEntity(new Uri(url), null, typeof(Stream));
        ...
        /// <remarks>
        ///     This property is relevant to Element, DocumentType and XmlDeclaration nodes only. (Other node types do not
        ///     have attributes.)
        /// </remarks>
        ...
        /// <remarks>
        ///     <para>
        ///         This method also releases any resources held while reading. If this reader was constructed using a stream,
        ///         this method also calls Close on the underlying stream.
        ///     </para>
        ...
        /// <returns>
        ///     The value of the specified attribute. If the attribute is not found, a null reference (Nothing in Visual
        ///     Basic) is returned. This method does not move the reader.
        /// </returns>
        /// <remarks>This method does not move the reader.</remarks>
        public override string GetAttribute(string name, string namespaceURI)
        {
            ...
            if (_currentNode != null)
                for (var n = 0; n < _currentNode.AttributeCount; n++)
                {
                    var qnameValue = _currentNode.Attributes[n];
        ...
        /// </param>
        /// <returns>
        ///     The namespace URI to which the prefix maps or a null reference (Nothing in Visual Basic) if no matching prefix
        ///     is found.
        /// </returns>
        ...
        /// <remarks>
        ///     After calling MoveToAttribute, the <see cref="LocalName" />, <see cref="NamespaceURI" />, and
        ///     <see cref="Prefix" /> properties reflects the properties of that attribute.
        /// </remarks>
        ...
        ///     The i parameter is less than 0 or greater than or equal to
        ///     AttributeCount.
        /// </exception>
        ...
        ///     to one of the following node types: Element, DocumentType, or XmlDeclaration.
        /// </remarks>
        ...
        /// </summary>
        /// <returns>
        ///     true if an attribute exists (the reader moves to the first attribute); otherwise, false (the position of the
        ...
        ///     MoveToNextAttribute returns true, the reader moves to the next attribute; otherwise, the position of the reader
        ///     does not change.
        /// </remarks>
        ...
        /// </summary>
        /// <exception cref="Exception">The method or operation is not implemented.</exception>
        public override XmlNameTable NameTable => _parser.NameTable;
        ...
        /// <remarks>
        ///     This property never returns the following XmlNodeType types: Document, DocumentFragment, Entity, EndEntity, or
        ///     Notation.
        /// </remarks>
        ...
        /// <remarks>
        ///     When a reader is first created and initialized, there is no information available. You must call Read to read
        ///     the first node.
        /// </remarks>
        ...
        /// </summary>
        /// <returns>
        ///     true if there are nodes to return. false if the reader is not positioned on an attribute node when the initial
        ///     call is made or if all the attribute values have been read. An empty attribute, such as, misc="", returns true with
        ///     a single node with a value of String.Empty.
        /// </returns>
        /// <remarks>
        ///     Use this method after calling MoveToAttribute to read through the text or entity reference nodes that make up
        ///     the attribute value. The Depth of the attribute value nodes is one plus the <see cref="Depth" /> of the attribute
        ///     node; it increments and decrements by one when you step into and out of general entity references.
        /// </remarks>
        ...
        /// </summary>
        /// <value>
        ///     The value returned depends on the <see cref="NodeType" /> of the node. The following table lists node types that
        ///     have a value to return. All other node types return String.Empty.
        ...
        ///     <para>XmlDeclaration - The content of the declaration.</para>
        /// </value>
